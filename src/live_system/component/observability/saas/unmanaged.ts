 ...
 */
export type SatisfiedObservabilitySaaSUnmanagedBuilder = {
  build: () => LiveSystemComponent;
};

export type ObservabilitySaaSUnmanagedBuilder = {
...
export type ObservabilitySaaSUnmanagedConfig = {
  id: string;
...
export namespace ObservabilitySaaSUnmanaged {
  export const getBuilder = (): ObservabilitySaaSUnmanagedBuilder => {
    const params = getParametersInstance();
    const inner = getLiveSystemComponentBuilder()
      .withType(buildObservabilitySaaSUnmanagedType())
      .withParameters(params)
      .withProvider('SaaS');

    const builder: ObservabilitySaaSUnmanagedBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedObservabilitySaaSUnmanagedBuilder = {
      build: () => inner.build(),
    };
  ...
  export const create = (
    config: ObservabilitySaaSUnmanagedConfig,
  ): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
