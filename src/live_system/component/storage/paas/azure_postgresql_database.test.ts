...
import {AzurePostgreSqlDatabase} from './azure_postgresql_database';
...
describe('AzurePostgreSqlDatabase', () => {
  describe('create()', () => {
    it('should build a component with the correct type string', () => {
      const c = AzurePostgreSqlDatabase.create(BASE_CONFIG);
    ...
    it('should set optional parameters', () => {
      const c = AzurePostgreSqlDatabase.create({
        ...BASE_CONFIG,
  ...
  describe('satisfy()', () => {
    it('should copy id, version, displayName from blueprint', () => {
      ...
      const c = AzurePostgreSqlDatabase.satisfy(bp.component).build();
