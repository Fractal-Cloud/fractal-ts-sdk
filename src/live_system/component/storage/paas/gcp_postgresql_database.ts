 ...
 */
export type SatisfiedGcpPostgreSqlDatabaseBuilder = {
  build: () => LiveSystemComponent;
};

export type GcpPostgreSqlDatabaseBuilder = {
...
export type GcpPostgreSqlDatabaseConfig = {
  id: string;
...
export namespace GcpPostgreSqlDatabase {
  export const getBuilder = (): GcpPostgreSqlDatabaseBuilder => {
    ...
    const builder: GcpPostgreSqlDatabaseBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedGcpPostgreSqlDatabaseBuilder = {
      build: () => inner.build(),
    };
  ...
  export const create = (
    config: GcpPostgreSqlDatabaseConfig,
  ): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
