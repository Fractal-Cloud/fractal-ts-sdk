...
export type SatisfiedAzureServiceBusTopicBuilder = {
...
export type AzureServiceBusTopicBuilder = {
...
export type AzureServiceBusTopicConfig = {
  id: string;
...
export namespace AzureServiceBusTopic {
  export const getBuilder = (): AzureServiceBusTopicBuilder => {
    ...
    const builder: AzureServiceBusTopicBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedAzureServiceBusTopicBuilder = {
      withAzureRegion: value => {
        pushParam(params, AZURE_REGION_PARAM, value);
  ...
  export const create = (
    config: AzureServiceBusTopicConfig,
  ): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
