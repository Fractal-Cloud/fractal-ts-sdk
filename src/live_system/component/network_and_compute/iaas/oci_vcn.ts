 ...
 */
export type SatisfiedOciVcnBuilder = {
  withCompartmentId: (id: string) => SatisfiedOciVcnBuilder;
  build: () => LiveSystemComponent;
};

export type OciVcnBuilder = {
...
export namespace OciVcn {
  export const getBuilder = (): OciVcnBuilder => {
    const params = getParametersInstance();
    const inner = getLiveSystemComponentBuilder()
      .withType(buildOciVcnType())
      .withParameters(params)
      .withProvider('OCI');

    const builder: OciVcnBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedOciVcnBuilder = {
      withCompartmentId: value => {
        pushParam(params, COMPARTMENT_ID_PARAM, value);
  ...
  export const create = (config: OciVcnConfig): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
