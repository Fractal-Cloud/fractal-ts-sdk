 ...
 */
export type SatisfiedApiManagementSaaSUnmanagedBuilder = {
  build: () => LiveSystemComponent;
};

export type ApiManagementSaaSUnmanagedBuilder = {
...
export type ApiManagementSaaSUnmanagedConfig = {
  id: string;
...
export namespace ApiManagementSaaSUnmanaged {
  export const getBuilder = (): ApiManagementSaaSUnmanagedBuilder => {
    const params = getParametersInstance();
    const inner = getLiveSystemComponentBuilder()
      .withType(buildApiManagementSaaSUnmanagedType())
      .withParameters(params)
      .withProvider('SaaS');

    const builder: ApiManagementSaaSUnmanagedBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedApiManagementSaaSUnmanagedBuilder = {
      build: () => inner.build(),
    };
  ...
  export const create = (
    config: ApiManagementSaaSUnmanagedConfig,
  ): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
