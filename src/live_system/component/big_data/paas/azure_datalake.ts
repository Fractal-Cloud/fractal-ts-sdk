...
export type SatisfiedAzureDatalakeBuilder = {
...
export type AzureDatalakeBuilder = {
...
export type AzureDatalakeConfig = {
  id: string;
...
export namespace AzureDatalake {
  export const getBuilder = (): AzureDatalakeBuilder => {
    ...
    const builder: AzureDatalakeBuilder = {
      withId: id => {
  ...
  export const satisfy = (
    ...
    const satisfiedBuilder: SatisfiedAzureDatalakeBuilder = {
      withAzureRegion: value => {
        pushParam(params, AZURE_REGION_PARAM, value);
  ...
  export const create = (config: AzureDatalakeConfig): LiveSystemComponent => {
    const b = getBuilder()
      .withId(config.id)
      .withVersion(
